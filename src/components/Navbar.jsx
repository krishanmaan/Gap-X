    ...
    return (
        <>
            ...
            <nav className=" bg-transparent backdrop-blur-sm  fixed w-full z-20  top-0 start-0 border-b border-gray-200 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto  pt-4 pl-4 pr-4">
                    ...
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <button type="button" className="text-white bg-transparent border hover:bg-gray-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  px-4 py-2 text-center   text-base">Join Airdrop</button>
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium font-Grandstander border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:border-gray-700">
                            <li>
                                <a href="#" className="block py-2 px-3 hover:text-xl text-white text-base hover:text-[#9E9CA2] rounded md:bg-transparent  md:p-0 " aria-current="page">HOME</a>
                            </li>
                            <li>
                                <a href="#aboutus" className="block py-2 px-3 hover:text-xl rounded  text-base hover:text-[#9E9CA2] md:hover:bg-transparent  md:p-0 text-white ">ABOUT US</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 hover:text-xl rounded  text-basehover:text-[#9E9CA2]  md:hover:bg-transparent  md:p-0  text-white ">TOKENOMICS</a>
                            </li>
                            <li>
                                <a href="#roadMap" className="block py-2 px-3 hover:text-xl  text-base rounded hover:text-[#9E9CA2]  md:hover:bg-transparent  md:p-0  text-white ">ROADMAP</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 hover:text-xl rounded text-base hover:text-[#9E9CA2]  md:hover:bg-transparent  md:p-0  text-white ">REFER & ERAN</a>
                            </li>
                        </ul>
                    </div>
                </div>
